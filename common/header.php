                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item" href="staff/staffDashboard.php">View Regd. Students</a></li>
                                    <li><a class="dropdown-item" href="staff/attendanceRecords.php">View Reports</a></li>
                                    <li><hr class="dropdown-divider"></li>
